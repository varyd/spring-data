...
public class DefaultArangoSearchOperations implements ArangoSearchOperations {
	...
	private final Map<CollectionCacheKey, ArangoSearchViewCacheValue> viewCache;
	private final PersistenceExceptionTranslator exceptionTranslator;

	public DefaultArangoSearchOperations(final ArangoSearch view,
		final Map<CollectionCacheKey, ArangoSearchViewCacheValue> viewCache,
